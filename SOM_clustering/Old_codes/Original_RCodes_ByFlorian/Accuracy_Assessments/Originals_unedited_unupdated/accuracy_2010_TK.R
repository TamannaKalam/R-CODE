...
# "//141.20.141.12/SAN_BioGeo/_SHARED_DATA/FP_TaKa/Harmony/600_extracts_Dec22.csv"
...
d10 <- c(37,38,60,63,75,96,117,133,147:149,153,154,155)
...
qq %>% 
  ...
  mutate(Dataset = factor(Dataset, levels = c("ESACCI-LC-L4-LCCS-Map-300m-P1Y-2010with_shrubs_Mask300",
                          ...
                          labels = c('CCI_2010_ws (binary)',
                                     ...
                                     'Ensemble_2010_wo_MODIS', "Tian_2010_8km"))) %>% 
